...
class trendingGif extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(

      title: 'GIFs en tendencia',
      theme: ThemeData(
...
class _GifListPageState extends State<GifListPage> {
  ...
  Future<void> fetchGifs() async {
    final response = await http.get(Uri.parse('https://api.giphy.com/v1/gifs/trending?api_key=ai9Esr9mgLg8Km1jQyS8J9HAJdzsuUOQ&limit=200&offset=0&rating=g&bundle=messaging_non_clips'));
