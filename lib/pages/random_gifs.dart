...
class _GifListPageState extends State<GifListPage> {
  ...
  Future<void> fetchGifs() async {
    final response = await http.get(Uri.parse('https://api.giphy.com/v2/emoji?api_key=ai9Esr9mgLg8Km1jQyS8J9HAJdzsuUOQ&limit=200&offset=0'));
