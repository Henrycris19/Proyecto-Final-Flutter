...
class stickers2 extends StatelessWidget {
  @override
...
class _GifListPageState extends State<GifListPage> {
  ...
  Future<void> fetchGifs() async {
    final response = await http.get(Uri.parse('https://api.giphy.com/v1/stickers/packs/3138/children?api_key=ai9Esr9mgLg8Km1jQyS8J9HAJdzsuUOQ&limit=200'));
